...
const slides = [
  ...
  {
    src: "/images/hero/hero-flagstone-firepit.jpg",
    alt: "Flagstone patio with fire pit and Adirondack chairs",
  },
  {
    src: "/images/hero/hero-hillside-firepit.jpg",
    alt: "Flagstone fire pit patio with boulder retaining wall and rolling countryside view",
  },
  {
...
export default function Hero() {
  ...
  return (
    <>
      ...
      {/* Welcome / intro section below slideshow */}
      <section className="bg-white py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">
            Full-Service Landscaping in the{" "}
            <span className="text-brand-gold-500">Chippewa Valley</span>
          </h1>
          <div className="w-16 h-0.5 bg-brand-gold-400 mx-auto mb-6" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-block bg-brand-gold-400 text-brand-green-900 px-8 py-3 rounded-lg font-bold hover:bg-brand-gold-300 transition shadow"
            >
              Get Free Quote
            </Link>
            <a
